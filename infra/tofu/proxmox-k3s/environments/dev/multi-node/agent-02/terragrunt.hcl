# Development Environment - Multi-Node K3s Agent 2 (Worker Node)
...
inputs = {
  ...
  vm_config = {
    ...
    storage     = "local-lvm"
    network     = "vmbr0"
    description = "K3s development cluster - agent node 2 (worker)"
  }
